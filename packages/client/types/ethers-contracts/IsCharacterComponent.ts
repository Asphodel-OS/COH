...
export interface IsCharacterComponentInterface extends utils.Interface {
  functions: {
...
export interface IsCharacterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsCharacterComponentInterface;
