...
export interface PriceSellComponentInterface extends utils.Interface {
  functions: {
...
export interface PriceSellComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceSellComponentInterface;
