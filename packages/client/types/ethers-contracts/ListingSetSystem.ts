...
export interface ListingSetSystemInterface extends utils.Interface {
  functions: {
...
export interface ListingSetSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ListingSetSystemInterface;
  ...
  functions: {
    ...
    executeTyped(
      merchantID: PromiseOrValue<BigNumberish>,
