...
export interface IdNodeComponentInterface extends utils.Interface {
  functions: {
...
export interface IdNodeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IdNodeComponentInterface;
