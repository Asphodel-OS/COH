...
export interface MediaURIComponentInterface extends utils.Interface {
  functions: {
...
export interface MediaURIComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MediaURIComponentInterface;
