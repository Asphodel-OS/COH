...
export interface ERC721PetSystemInterface extends utils.Interface {
  functions: {
...
export interface ERC721PetSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721PetSystemInterface;
