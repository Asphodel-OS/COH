...
export interface IdMerchantComponentInterface extends utils.Interface {
  functions: {
...
export interface IdMerchantComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IdMerchantComponentInterface;
