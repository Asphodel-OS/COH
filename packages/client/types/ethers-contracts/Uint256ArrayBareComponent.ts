...
export interface Uint256ArrayBareComponentInterface extends utils.Interface {
  functions: {
...
export interface Uint256ArrayBareComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Uint256ArrayBareComponentInterface;
