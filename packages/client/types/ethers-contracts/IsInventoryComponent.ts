...
export interface IsInventoryComponentInterface extends utils.Interface {
  functions: {
...
export interface IsInventoryComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsInventoryComponentInterface;
