...
export interface BatteryCapacityComponentInterface extends utils.Interface {
  functions: {
...
export interface BatteryCapacityComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BatteryCapacityComponentInterface;
