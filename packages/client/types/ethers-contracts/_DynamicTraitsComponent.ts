...
export interface _DynamicTraitsComponentInterface extends utils.Interface {
  functions: {
...
export interface _DynamicTraitsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _DynamicTraitsComponentInterface;
