...
export interface OperatorComponentInterface extends utils.Interface {
  functions: {
...
export interface OperatorComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OperatorComponentInterface;
