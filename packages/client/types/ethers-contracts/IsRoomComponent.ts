...
export interface IsRoomComponentInterface extends utils.Interface {
  functions: {
...
export interface IsRoomComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsRoomComponentInterface;
