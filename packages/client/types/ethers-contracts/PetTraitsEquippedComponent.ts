...
export interface PetTraitsEquippedComponentInterface extends utils.Interface {
  functions: {
...
export interface PetTraitsEquippedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PetTraitsEquippedComponentInterface;
