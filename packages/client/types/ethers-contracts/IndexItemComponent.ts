...
export interface IndexItemComponentInterface extends utils.Interface {
  functions: {
...
export interface IndexItemComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexItemComponentInterface;
